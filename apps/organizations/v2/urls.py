...
app_name = "organizations_v2"

urlpatterns = [
    # v2-enhanced read endpoints
    path("", OrganizationListViewV2.as_view(), name="org-list"),
    path("<uuid:pk>/", OrganizationDetailViewV2.as_view(), name="org-detail"),
    path("<uuid:pk>/members/", MemberListViewV2.as_view(), name="org-member-list"),
    path("<uuid:pk>/stats/", OrganizationStatsView.as_view(), name="org-stats"),  # NEW in v2
